...
export default Record = () => {
    const audioRecorder: AudioRecorder = new AudioRecorder();

    return (
        <>
            <KeyboardAwareScrollView bounces={false} contentContainerStyle={styles.main} keyboardShouldPersistTaps='handled'>
